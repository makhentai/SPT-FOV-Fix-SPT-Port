  ...
  public static class Utils
    {
        ...
        // Ported note: IsSight(Mod) targeted an obfuscated "TemplateIdToObjectMappingsClass.TypeTable"
        // from the original build with no found 4.1.3 equivalent. Dropped rather than guessed at -
        // it was never actually called anywhere in the mod (dead code in the upstream source too).
